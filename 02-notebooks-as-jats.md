...
The element may either provide a local path to a REES compliant folder or provide a remote path to a `git` repo which when cloned will providea  REES complaint folder. 
